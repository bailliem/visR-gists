...
## ----naclus,h=5,w=7,ps=11,cap='Cluster analysis showing which predictors tend to be missing on the same patients',scap='Cluster analysis of missingness in SUPPORT'----
...
survplot(r, random.number, label.curve=FALSE)   # Figure (*\ref{fig:support-lognorm-resid}*)
